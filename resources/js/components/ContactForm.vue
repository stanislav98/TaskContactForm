<template>
	 <div class="max-w-5xl px-6 py-16 mx-auto">
      <flash-message :message="message" v-if="submited" @hideMessage="hide"></flash-message>
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            <h1 class="text-4xl lg:text-5xl font-bold leading-tight">Contact us!</h1>
            <div class="text-gray-700 mt-8">
              Hate forms? Send us an <span class="underline"><a href="mailto:someemail@info.com">email</a></span> instead.
            </div>
          </div>
        ...
        <div>
          <div>
            ...
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline"
              type="text" placeholder="Input name and surname"  v-model="form.name">
             <p class="text-red-500 text-xs italic absolute" v-if="this.errors['name']">{{ this.errors['name'][0] }}</p>
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Email</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline"
              type="text"  placeholder="Email" v-model="form.email">
             <p class="text-red-500 text-xs italic absolute" v-if="this.errors['email']">{{ this.errors['email'][0] }}</p>
          </div>
            <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Phone</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline"
              type="text"  placeholder="Enter phone in format like 0885588111" v-model="form.phone">
             <p class="text-red-500 text-xs italic absolute" v-if="this.errors['phone']">{{ this.errors['phone'][0] }}</p>
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Message</span>
            <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline"
             v-model="form.message" placeholder="Enter your message"
            ></textarea>
            <p class="text-red-500 text-xs italic absolute -mt-1" v-if="this.errors['message']">{{ this.errors['message'][0] }}</p>
          </div>
          <div class="mt-8">
            <button
              class="block px-8 py-2 mt-6 text-lg font-medium text-center text-white transition-colors duration-300 transform bg-indigo-600 rounded md:mt-0 hover:bg-indigo-500 w-full" @click="submitForm">
              Send Message
            </button>
          </div>
        </div>
    ...
    components: {
      'flash-message': FlashMessage
        ...
        this.processing = true;
          ...
          //handle fail when email is not sent and show message
